window.VLibras = (function (t) {
    ...
    function (t, e, n) {
        ...
        const i = () => v(document.body, "vpw-fullscreen"),
            ...
            h = () => {
                const { clientWidth: t, clientHeight: e } =
            ...
            m = (t) => {
                g(u(".vpw-skip-welcome-message"), "vp-disabled", t),
                    g(u("[vp-click-blocker]"), "vp-enabled", t);
            },
            y = () =>
    ...
    function (t, e, n) {
        const i = n(6),
            o = n(10);
        n(14);
        const { $: r, $$: a, removeClass: s, getWidget: c } = n(2),
            { ROOT_PATH: l } = n(3),
            u = ["TL", "T", "TR", "L", "R", "BL", "B", "BR"],
            d = ["icaro", "hosana", "guga", "random"];
        t.exports = function (...t) {
            const e = "object" == typeof t[0] && t[0],
                n = e ? e.personalization : t[1];
            let p = e ? e.rootPath : t[0],
                v = e ? e.position : t[3],
                f = e ? e.opacity : t[2],
                h = e.avatar;
            void 0 === p ? (p = l) : p && !p.endsWith("/") && (p += "/"),
                (isNaN(f) || f < 0 || f > 1) && (f = 1),
                u.includes(v) || (v = "R"),
                d.includes(h) || (h = "icaro");
            const w = new o(),
                g = new i({
                    rootPath: p,
                    pluginWrapper: w,
            ...
            window.onload && (b = window.onload),
                (window.onload = () => {
                    a("[vw]").forEach((t) => {
                        ...
                        b && b(),
                        (this.element = r("[vw-plugin-wrapper]").closest(
                            "[vw]"
                        )),
                        g.load(r("[vw-access-button]"), this.element),
                        w.load(r("[vw-plugin-wrapper]")),
                        window.addEventListener(
                            "vp-widget-wrapper-set-side",
                            (t) => {
                                const e = t.detail;
                                if (!e || !u.includes(e)) return;
                                (this.element = c()),
                ...
                this.element.addEventListener("click", async () => {
                    ...
                    const { Plugin: t } = await n.e(0).then(n.bind(null, 17)),
                        { loadTextCaptureScript: e } = await n
                            .e(0)
                            .then(n.bind(null, 18)),
                        { addWidgetEventListeners: i } = await n
                            .e(0)
                            .then(n.bind(null, 19));
                    ...
                    if (
                        (window.plugin ||
                            (window.plugin = new window.VLibras.Plugin(a)),
                        this.ready)
                    )
                        e();
                    else {
